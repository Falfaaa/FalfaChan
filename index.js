...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	        ...
	        console.log(color(`\n${themeemoji} YT CHANNEL: Yuuzzz?`,'magenta'))
            console.log(color(`${themeemoji} GITHUB: YuzkiTodz`,'magenta'))
            console.log(color(`${themeemoji} INSTAGRAM: @yuuzzz_hunt`,'magenta'))
